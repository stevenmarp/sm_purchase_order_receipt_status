# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Track goods receipt progress on purchase orders: Waiting, Input Stock, Quality Stock, Partially Received, Overdue or Fully Received badge with filters and a direct link to the pending input or quality transfer, for 1, 2 and 3-step receiving in Odoo 18.',
    'description': """
Purchase Order Receipt Status for Odoo 18
==========================================
...
overdue receipt, Odoo 18 purchase receipt.
    """,
    'author': 'Steven Marp',
